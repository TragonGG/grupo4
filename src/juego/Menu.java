...
public class Menu {
    ...
    public Menu(double x, double y, double ancho, double alto) {
        ...
        // Configurar datos para botón lanzar
        this.rectLanzarAncho = 140;
        this.rectLanzarAlto = 45;
        this.lanzarX = x;
        this.lanzarY = y + alto/2 - 85;
    }
    ...
    public void dibujar(Entorno entorno, Mago mago) {
        ...
        entorno.cambiarFont("Gabriola", 44, new Color(200, 200, 230));
        entorno.escribirTexto("JavaAO", x-50, y - alto/2 + 190);
        ...
        // Dibujar rectángulo detrás del texto "Lanzar" con centro en lanzarX/lanzarY
        entorno.dibujarRectangulo(lanzarX, lanzarY, rectLanzarAncho, rectLanzarAlto, 0, new Color(70, 70, 80, 200));

        // Texto "Lanzar" centrado en lanzarX/lanzarY
        if (lanzarSeleccionado) {
            entorno.cambiarFont("Gabriola", 26, new Color(50, 255, 50));
        } else {
            entorno.cambiarFont("Gabriola", 26, new Color(230, 230, 230));
        }
        entorno.escribirTexto("Lanzar", lanzarX-50, lanzarY);
    }
    ...
    public void verificarClick(int mouseX, int mouseY) {
        ...
        // Área clickeable para botón lanzar
        if (mouseX >= lanzarX - rectLanzarAncho/2 && mouseX <= lanzarX + rectLanzarAncho/2 &&
            mouseY >= lanzarY - rectLanzarAlto/2 && mouseY <= lanzarY + rectLanzarAlto/2) {
